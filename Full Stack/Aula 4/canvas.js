...
function desenhar_triangulo(ctx,a,b,c,d,e,f,cor,i){
    ctx.beginPath()
    ctx.strokeStyle = cor
    ctx.moveTo(a,b);
    ctx.lineTo(c,d);
...
desenhar_quadrado(ctx,0,200,40,200,"#65a1dd") //agua cima pra baixo
...
desenhar_triangulo(ctx,120,140,158,90,200,140,"orange")
desenhar_arco(ctx,240,70,35,0,2,"yellow",4,"yellow")
desenhar_arco(ctx,268,210,20,0,2,"green",4,"green")
desenhar_arco(ctx,48,180,20,0,2,"green",4,"green")
desenhar_arco(ctx,10,220,30,0,2,"#65a1dd",4,"#65a1dd")
desenhar_arco(ctx,120,291,30,0,2,"#65a1dd",4,"#65a1dd")
ctx.moveTo(100,20);
ctx.lineTo(180,100);
ctx.lineTo(20,100);
ctx.lineTo(100,20);